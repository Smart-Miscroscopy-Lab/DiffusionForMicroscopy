...
data = Dataset.ImageFolder(root= '/users/gpb21161/Grant/Datasets/MNIST')
...
def load_transformed_dataset():
    ...
    train = Dataset.ImageFolder(root= '/users/gpb21161/Grant/Datasets/MNIST', transform=data_transform)

    test = Dataset.ImageFolder(root= '/users/gpb21161/Grant/Datasets/MNIST', transform=data_transform)
...
writer = SummaryWriter(log_dir="runs/diffusion_model_experiment")
...
noisy_images_dir = "saved_images/noisy"
generated_images_dir = "saved_images/generated"
...
for epoch in range(epochs):
    for step, batch in enumerate(dataloader):
        ...
        if epoch % 2 == 0 and step == 0:
            ...
            torchvision.utils.save_image(
                grid_generated, f"{generated_images_dir}/epoch_{epoch:03d}_generated.png", normalize=True, range=(-1, 1)
            )
