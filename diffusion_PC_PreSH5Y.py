...
writer = SummaryWriter(log_dir="runsPC_SH5Y_RESNET/diffusion_model_experiment")
...
final_images_dir = "saved_images_PC_SH5Y_RESNET/final"
model_save_dir = "saved_models_PC_SH5Y_RESNET"
