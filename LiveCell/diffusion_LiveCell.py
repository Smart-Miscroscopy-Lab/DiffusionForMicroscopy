...
def load_transformed_dataset():
    ...
    test = Dataset.ImageFolder(root= 'users/gpb21161/Grant/Datasets/LiveCell/BT474', transform=data_transform)
...
writer = SummaryWriter(log_dir="runsPC_LiveCell_Single/diffusion_model_experiment")
...
final_images_dir = "saved_images_PC_LiveCell_Single/final"
