...
img_dir = '/users/gpb21161/Grant/Datasets/LiveCell/BT474'
...
def load_checkpoint(checkpoint_path, model, optimizer=None):
    ...
    print(f"Checkpoint loaded: {checkpoint_path} (Epoch {start_epoch - 1}, Loss {loss})")
...
# %%
writer = SummaryWriter(log_dir="runsPC_multinode/diffusion_model_experiment")
...
scaler = GradScaler()  # Initialize GradScaler for MPT
epochs = 100000
...
checkpoint_dir = "checkpointsBT474"
...
for epoch in range(epochs):
    ...
    # Save model and optimizer states at specified intervals
    if epoch % 10 == 0 or epoch == epochs - 1:  # Save every 10 epochs and the final epoch
