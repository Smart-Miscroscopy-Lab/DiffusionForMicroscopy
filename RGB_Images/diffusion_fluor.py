...
from FluorescenceDataset import FluorescenceDataset
...
def forward_diffusion_sample(x_0, t, device="cpu"):
    ...
    """
    x_0 = x_0.unsqueeze(0)  # Add a batch dimension
...
data = FluorescenceDataset(root_dir= '/users/gpb21161/Grant/Datasets/threeMSCIMGClasses', image_size=IMG_SIZE, desired_padding=int(0.2*IMG_SIZE))
...
writer = SummaryWriter(log_dir="runsfluor/diffusion_model_experiment")
...
noisy_images_dir = "saved_images_fluor/noisy"
generated_images_dir = "saved_images_fluor/generated"
